...
public class Othello_online
{
    ...
    public void play()
    {
        ...
        while (!this.gameOver())
        {
            ...
            while (!valid)
            {
                Point p = this.gameBoard.getClick();
                if (p==null){
                    continue;
                }
                row = p.x;
    ...
    /**
     * This method will handle the logic of a single turn in the Othello_online game.
     ...
     * POST: The pegs of the opposite colour are flipped according to the rules of Othello_online.
     */
    ...
    {
        Othello_online game = new Othello_online();
        game.play();
    }
